...
The code behing this can be found [[https://github.com/Ezibenroc/platform-calibration/blob/master/src/calibration/calibrate.c][here]]. The below command line uses this [[file:exp_input/mpi_calibration/][input]]
produces this [[file:exp_output/mpi_calibration/][output]] which is then used by these [[file:exp_analysis/mpi_calibration/][notebooks]].
#+begin_src sh :results output :exports both
