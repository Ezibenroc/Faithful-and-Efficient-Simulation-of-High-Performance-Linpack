...
The below command line uses this [[file:exp_input/mpi_calibration/][input]], produces this [[file:exp_output/mpi_calibration/][output]] which is then used
by these [[file:exp_analysis/mpi_calibration/][notebooks]].
#+begin_src sh :results output :exports both
...
The below command line uses these [[file:exp_input/kernel_calibration/][inputs]], produces this [[file:exp_output/kernel_calibration/][output]] which is then used
by this [[file:exp_analysis/kernel_calibration/][notebook]].
#+begin_src sh :results output :exports both
